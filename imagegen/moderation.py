...
# configured — a deployment running image generation without that key
# (e.g. Flux-only) has *no* substantive moderation beyond this list, which
# is a product/legal decision to sign off on explicitly, not something this
# comment alone should be taken as clearing.
